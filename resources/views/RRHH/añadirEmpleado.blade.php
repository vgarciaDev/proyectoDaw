...
@section('content')    
    <div class="container mt-5">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <form action="{{route('añadirEmpleado')}}" method="post">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="ss_number" name="ss_number">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="proffesional_category" name="proffesional_category">
                    </div>
        
                    <div class="mb-3">
                        <label for="irpf_withholding" class="form-label">Retención IRPF (%):</label>
                        <input type="number" class="form-control" id="irpf_withholding" name="irpf_withholding">
                    </div>
        
                    <div class="mb-3">
                        <label for="ss_contribution" class="form-label">Contribución Seguridad Social:</label>
                        <input type="number" class="form-control" id="ss_contribution" name="ss_contribution">
                    </div>
